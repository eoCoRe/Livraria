...
<body style="background-color: #25aaad;">
<nav class="navbar navbar-dark bg-dark fixed-top">
  <div class="container-fluid">
    <a class="navbar-brand" href="#">LIVRARIA BOGA</a>
    <button class="navbar-toggler" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasDarkNavbar" aria-controls="offcanvasDarkNavbar">
      <span class="navbar-toggler-icon"></span>
    </button>
    <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
      <div class="offcanvas-header">
        <h5 class="offcanvas-title" id="offcanvasDarkNavbarLabel">LIVRARIA BOGA</h5>
      ...
      <div class="offcanvas-body">
        ...
        <form class="d-flex mt-3" role="search">
          ...
          <button class="btn btn-success" type="submit">PESQUISE</button>
        </form>
      </div>
    </div>
  </div>
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      <img src="../img/carrosel3.png" class="d-block w-100" alt="...">
    </div>
  </div>
